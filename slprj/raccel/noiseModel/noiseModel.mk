...
MODEL                   = noiseModel
MODULES                 = noiseModel.c noiseModel_capi.c noiseModel_data.c noiseModel_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = noiseModel.exe
MAKEFILE                = noiseModel.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2023b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2023b
START_DIR               = C:\Users\anigo\OneDrive\Documents\PSP\AC\noise_integration
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = noiseModel_ref.rsp
COMPILER_COMMAND_FILE     = noiseModel_comp.rsp
